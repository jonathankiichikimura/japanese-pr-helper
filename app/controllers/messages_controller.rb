class MessagesController < ApplicationController
  ...
  def create
    ...
    if @message.save
      ...
      response = ruby_llm_chat.with_instructions(set_history_and_context).ask(@message.content)
  ...
  def set_history_and_context
    ...
    "Here is the application description: #{@application_journey.description}.\n
